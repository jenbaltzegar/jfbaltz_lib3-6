...
# Copy catalog file from lib3 analysis to use to create catalogue
# for combined dataset. This is done because of poorer quality coverage
# for lib3 compared to lib6. Hopefully, this will reduce lane effects.
cp /home/megan/temp_JenB/jfbaltz_lib3/info/popmaps/popmap.catalog.tsv ./
...
#######################################
echo "Running rxstacks to improve catalog..."
#######################################
mkdir rxstacks
cd rxstacks
